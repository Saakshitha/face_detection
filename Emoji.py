...
def detectWebcamExpression():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == ord('q'):  # Change this line to check 'q' key every frame     
            break
    cap.release()
...
emotion_webcam = Button(main, text="Detect Facial Expression from WebCam", command=detectWebcamExpression)
emotion_webcam.place(x=50, y=250)
emotion_webcam.config(font=font1)
